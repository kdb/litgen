...
<!-- Viser formularen 'Podcast' -->

<form id="form_podcast">
    <table border="0">
        <tr>
        ...
        <tr>            
            <td>
            	<b>Dato for udgivelse</b><br><input size="2" maxlength="2" type="text" name="posted_d" value="<?=$_REQUEST['posted_d']?>">.<input size="2" maxlength="2" type="text" name="posted_m" value="<?=$_REQUEST['posted_m']?>">.<input size="4" maxlength="4" type="text" name="posted_y" value="<?=$_REQUEST['posted_y']?>"><font size="2">dd.mm.åååå</font>
            </td>
        </tr>
        <tr>                        	
            <td>
        ...
        <tr>
            <td>
                <input type="submit" name="submitKnap" value="Tilføj" onClick="return validateForm('podcast')">
                <?=$reset?>
            </td>
        </tr>    
    </table>
    <input type="hidden" name="ressource" value="podcast">
</form>

<?php              
    ...
    if(empty($_REQUEST['blogtitel']))	$_REQUEST['blogtitel']="";    
...
<form id="form_blog">
    <table border="0">
        ...
        <tr>
            <td>
            	<img src="images/dut.gif" alt="" /><b>Titel på indlæg</b><br><input size="30" type="text" name="titel" value="<?=$_REQUEST['titel']?>">
            </td>
            <td>
            	<img src="images/dut.gif" alt="" /><b>Titel på blog</b><br><input size="30" type="text" name="blogtitel" value="<?=$_REQUEST['blogtitel']?>">
            </td>
        <tr>            
            <td>
            	<img src="images/dut.gif" alt="" /><b>Dato for indlæg</b><br><input size="2" maxlength="2" type="text" name="posted_d" value="<?=$_REQUEST['posted_d']?>">.<input size="2" maxlength="2" type="text" name="posted_m" value="<?=$_REQUEST['posted_m']?>">.<input size="4" maxlength="4" type="text" name="posted_y" value="<?=$_REQUEST['posted_y']?>"><font size="2">dd.mm.åååå</font>
            </td>
        </tr>
        <tr>                        	
            <td>
        ...
        <tr>
            <td>
                <input type="submit" name="submitKnap" value="Tilføj" onClick="return validateForm('blog')">
                <?=$reset?>
            </td>
        </tr>    
    </table>
    <input type="hidden" name="ressource" value="blog">    
</form>
